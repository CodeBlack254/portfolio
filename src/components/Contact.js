...
import flutterLogo from '../assets/flutter-svgrepo-com.svg'; 
    ...
    emailjs
      ...
      .then(
        (result) => {
          ...
          toast.success('👍 Message Sent Successfully, I will get back to you ASAP !!🙂');
          resetForm();
        },
        (error) => {
  ...
  return (
      <div className='contact' id='contactme'>
          <div className='container'>
              ...
              <div className='row'>
                  <div className='col-6'>
                      <p className='contanct_header'>You can send your message here 👇</p>
                  ...
                  <div className='col-6'>
                    ...
                    <div className='row'>
                        ...
                        <div className='col-4'>
                        <img className='techimages6' src={flutterLogo} alt="Flutter Logo" /> 
                        {/* <img className='techimages6' src='https://www.vectorlogo.zone/logos/flutterio/flutterio-icon.svg' alt='flutter icon'></img> */}
